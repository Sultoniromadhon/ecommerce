...
class Controller extends BaseController
{
	...
	public function __construct()
	{
        ...
        // $this->rajaOngkirApiKey = config('75d22b9d42f50293852e13006a4d6743');
        // $this->rajaOngkirBaseUrl = config('https://api.rajaongkir.com/starter/');
        // $this->rajaOngkirOrigin = config('501');
	...
	protected function initPaymentGateway()
	{
        ...
        \Midtrans\Config::$serverKey = config('midtrans.servoerKey');
