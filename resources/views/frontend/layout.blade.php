                ...
                <div class="container-fluid">
                    <div class="header-bottom-wrapper">
                        <div class="logo-2 furniture-logo ptb-30">
                            <a href="/">
                                <img src="{{ asset('themes/ezone/assets/img/logo/logo.webp') }}" alt="" width="150px">
                            </a>
                        </div>
                         ...
                         <div class="menu-style-2 furniture-menu menu-hover">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="{{ url('wishlists') }}">whistlist</a></li>
                ...
                <div class="container-fluid">
                    <div class="widget-wrapper">
                        <div class="footer-widget mb-30">
                            <a href="#"><img src="{{ asset('themes/ezone/assets/img/logo/logo.webp') }}" alt="" width="200px"></a>
